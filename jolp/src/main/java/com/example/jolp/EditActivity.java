...
import com.example.jolp.timetableview.Schedule;
import com.example.jolp.timetableview.Time;
...
public class EditActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void init(){
        ...
        classroomEdit = findViewById(R.id.classroomedit);
        professorEdit = findViewById(R.id.professoredit);
    ...
    private void checkMode(){
        Intent i = getIntent();
        mode = i.getIntExtra("mode",FeedBack.REQUEST_ADD);

        if(mode == FeedBack.REQUEST_EDIT){
            loadScheduleData();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.submit_btn:
                ...
                else if(mode == FeedBack.REQUEST_EDIT){
                    inputDataProcessing();
                    Intent i = new Intent();
                    ArrayList<Schedule> schedules = new ArrayList<Schedule>();
                    schedules.add(schedule);
